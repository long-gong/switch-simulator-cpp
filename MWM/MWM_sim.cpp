//
// Created by Long Gong on 9/28/16.
//
...
int main(int argc, char* argv[]) {
  ...
  std::string fn = "../results/MWM-" + std::to_string(sw.params.N) + "-" +
  ...
  MWM mwm_s(sw.params.N); /* create a MWM scheduler */

  RV rv_for_tgen(sw.params.seed);

  main_run(sw, rv_for_tgen, &mwm_s, results);
