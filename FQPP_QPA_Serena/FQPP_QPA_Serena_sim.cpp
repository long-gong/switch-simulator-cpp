#include "../QPP_QPA_Serena/QPP_QPA_Serena.hpp"
...
int main(int argc, char* argv[]){
    ...
    std::string fn = "../results/FQPP_QPA_Serena-" + std::to_string(sw.params.N) +
    ...
    for (int i = -1;i <= 6;++ i){
        ...
        QPP_QPA_Serena qpp_qpa_serena_s(sw.params.N, seed1, 5, f); /* create a FQPS_iSLIP scheduler */
        main_run(sw, rv_for_tgen, &qpp_qpa_serena_s, results);
        delete f;
    }
