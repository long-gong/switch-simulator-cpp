...
int main(int argc, char* argv[]) {
  ...
  std::string fn = "../results/iSLIP_ShakeUp-" + std::to_string(sw.params.N) +
  ...
  iSLIP_ShakeUp islip_shakeup_s(sw.params.N,
                                seed1); /* create a iSLIP_ShakeUp scheduler */

  RV rv_for_tgen(sw.params.seed);

  main_run(sw, rv_for_tgen, &islip_shakeup_s, results);
