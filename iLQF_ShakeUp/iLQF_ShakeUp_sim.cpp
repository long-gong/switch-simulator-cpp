...
int main(int argc, char* argv[]) {
  ...
  std::string fn = "../results/iLQF_ShakeUp-" + std::to_string(sw.params.N) +
  ...
  iLQF_ShakeUp ilqf_shakeup_s(sw.params.N, seed1); /* create a iLQF scheduler */

  RV rv_for_tgen(sw.params.seed);

  main_run(sw, rv_for_tgen, &ilqf_shakeup_s, results);
