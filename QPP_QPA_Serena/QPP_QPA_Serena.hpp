//
//
#ifndef QPP_QPA_SERENA_HPP
#define QPP_QPA_SERENA_HPP
#include "../QPP_QPA/QPP_QPA.hpp"
#include "../Serena/Serena.hpp"

class QPP_QPA_Serena : public QPP_QPA, public Serena {
 public:
  QPP_QPA_Serena(int port_num, unsigned seed, int b = 5, weight_fun *wf = NULL)
      : Scheduler(port_num),
        iScheduler(port_num),
        QPP_QPA(port_num, seed, b, wf),
        Serena(port_num) {}
...
void QPP_QPA_Serena::run(lws_param_t &g_params, lws_status_t &g_status) {
  ...
  /*! Step 1: QPS */
  QPP_QPA::one_round_(g_status.Q, r_matching);
